...
#define spiMessage_init_default                  {_spiBus_MIN, _clockMode_MIN, 0, _spiDirection_MIN, false, 0}
...
#define spiMessage_init_zero                     {_spiBus_MIN, _clockMode_MIN, 0, _spiDirection_MIN, false, 0}
...
extern const pb_field_t spiMessage_fields[6];
