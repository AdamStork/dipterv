...
typedef enum _responseWriteEnum {
    responseWriteEnum_LED_SET = 0,
    responseWriteEnum_I2C_WRITE_OK = 1,
    responseWriteEnum_I2C_WRITE_FAIL = 2,
    responseWriteEnum_SPI_TRANSMISSION_OK = 3,
    responseWriteEnum_SPI_TRANSMISSION_FAIL = 4,
    responseWriteEnum_USART_TX_OK = 5,
    responseWriteEnum_USART_TX_FAIL = 6,
    responseWriteEnum_GPIO_SET_HIGH = 7,
    responseWriteEnum_GPIO_SET_LOW = 8,
    responseWriteEnum_GPIO_WRITE_FAIL = 9,
    responseWriteEnum_PWM_SET = 10,
    responseWriteEnum_PWM_RESET = 11,
    responseWriteEnum_PWM_SET_FAIL = 12
} responseWriteEnum;
#define _responseWriteEnum_MIN responseWriteEnum_LED_SET
#define _responseWriteEnum_MAX responseWriteEnum_PWM_SET_FAIL
#define _responseWriteEnum_ARRAYSIZE ((responseWriteEnum)(responseWriteEnum_PWM_SET_FAIL+1))
...
typedef struct _responseMessage {
    ...
    responseWriteEnum responseWrite;
...
#define responseMessage_init_default             {false, 0, false, _responseWriteEnum_MIN}
...
#define responseMessage_init_zero                {false, 0, false, _responseWriteEnum_MIN}
...
#define responseMessage_responseWrite_tag        2
