...
#define responseMessage_init_default             {false, 0, false, _successfulWrite_MIN}
...
#define responseMessage_init_zero                {false, 0, false, _successfulWrite_MIN}
