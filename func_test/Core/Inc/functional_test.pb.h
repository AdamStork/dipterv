...
typedef enum _i2cSpeedMode {
    i2cSpeedMode_I2C_SPEED_MODE_STANDARD = 1,
    i2cSpeedMode_I2C_SPEED_MODE_FAST_TLOW_THIGH_2 = 2,
    i2cSpeedMode_I2C_SPEED_MODE_FAST_TLOW_THIGH_16_9 = 3
} i2cSpeedMode;
#define _i2cSpeedMode_MIN i2cSpeedMode_I2C_SPEED_MODE_STANDARD
#define _i2cSpeedMode_MAX i2cSpeedMode_I2C_SPEED_MODE_FAST_TLOW_THIGH_16_9
#define _i2cSpeedMode_ARRAYSIZE ((i2cSpeedMode)(i2cSpeedMode_I2C_SPEED_MODE_FAST_TLOW_THIGH_16_9+1))
...
typedef enum _spiFrameFormat {
    spiFrameFormat_SPI_FRAME_FORMAT_MOTOROLA_MSB_FIRST = 0,
    spiFrameFormat_SPI_FRAME_FORMAT_MOTOROLA_LSB_FIRST = 1,
    spiFrameFormat_SPI_FRAME_FORMAT_TI = 2
} spiFrameFormat;
#define _spiFrameFormat_MIN spiFrameFormat_SPI_FRAME_FORMAT_MOTOROLA_MSB_FIRST
...
#define i2cMessage_init_default                  {_i2cBus_MIN, 0, 0, _i2cDirection_MIN, _i2cSpeedMode_MIN, 0}
#define spiMessage_init_default                  {_spiBus_MIN, _clockMode_MIN, 0, _spiDirection_MIN, 0, _spiOperatingMode_MIN, _spiHardwareNSS_MIN, _spiFrameFormat_MIN, _spiDataSize_MIN}
...
#define usartMessage_init_default                {_usartBus_MIN, _usartMode_MIN, 0, _usartWordLength_MIN, _usartParity_MIN, _usartStopBits_MIN, _usartDirection_MIN}
...
#define i2cMessage_init_zero                     {_i2cBus_MIN, 0, 0, _i2cDirection_MIN, _i2cSpeedMode_MIN, 0}
#define spiMessage_init_zero                     {_spiBus_MIN, _clockMode_MIN, 0, _spiDirection_MIN, 0, _spiOperatingMode_MIN, _spiHardwareNSS_MIN, _spiFrameFormat_MIN, _spiDataSize_MIN}
...
#define usartMessage_init_zero                   {_usartBus_MIN, _usartMode_MIN, 0, _usartWordLength_MIN, _usartParity_MIN, _usartStopBits_MIN, _usartDirection_MIN}
...
#define spiMessage_direction_tag                 4
#define spiMessage_dummyclocks_tag               5
#define spiMessage_operatingMode_tag             6
#define spiMessage_hardwareNSS_tag               7
#define spiMessage_frameFormat_tag               8
#define spiMessage_dataSize_tag                  9
...
extern const pb_field_t i2cMessage_fields[7];
