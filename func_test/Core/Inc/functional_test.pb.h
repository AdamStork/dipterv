...
/* Generated by nanopb-0.3.9.3 at Sun Apr 26 15:32:51 2020. */
...
#define _CommandTypeEnum_MIN CommandTypeEnum_Show_empty
...
typedef enum _spiOperatingMode {
    ...
    spiOperatingMode_SPI_MODE_TRANSMIT_4WIRE_MASTER = 1,
    spiOperatingMode_SPI_MODE_RECEIVE_4WIRE_MASTER = 2,
    spiOperatingMode_SPI_MODE_HALF_DUPLEX_TX_MASTER = 3,
    spiOperatingMode_SPI_MODE_HALF_DUPLEX_RX_MASTER = 4
} spiOperatingMode;
#define _spiOperatingMode_MIN spiOperatingMode_SPI_MODE_FULL_DUPLEX_MASTER
#define _spiOperatingMode_MAX spiOperatingMode_SPI_MODE_HALF_DUPLEX_RX_MASTER
#define _spiOperatingMode_ARRAYSIZE ((spiOperatingMode)(spiOperatingMode_SPI_MODE_HALF_DUPLEX_RX_MASTER+1))
...
typedef enum _adcClockPrescaler {
    adcClockPrescaler_ADC_PCLK2_DIVIDED_BY_2 = 0,
    adcClockPrescaler_ADC_PCLK2_DIVIDED_BY_4 = 1,
    adcClockPrescaler_ADC_PCLK2_DIVIDED_BY_6 = 2,
    adcClockPrescaler_ADC_PCLK2_DIVIDED_BY_8 = 3
} adcClockPrescaler;
#define _adcClockPrescaler_MIN adcClockPrescaler_ADC_PCLK2_DIVIDED_BY_2
...
typedef enum _usartDirection {
    ...
    usartDirection_USART_TX_AND_RX = 2
} usartDirection;
...
typedef enum _responseEnum_t {
    responseEnum_t_INVALID_MESSAGE = 0,
    responseEnum_t_I2C_WRITE_OK = 10,
    responseEnum_t_I2C_WRITE_FAIL = 11,
    responseEnum_t_I2C_READ_FAIL = 12,
    responseEnum_t_SPI_TRANSMISSION_OK = 20,
    responseEnum_t_SPI_TRANSMISSION_FAIL = 21,
    responseEnum_t_USART_TX_OK = 30,
    responseEnum_t_USART_TX_FAIL = 31,
    responseEnum_t_USART_RX_FAIL = 32,
    responseEnum_t_USART_TX_RX_FAIL = 33,
    responseEnum_t_GPIO_SET_HIGH = 40,
    responseEnum_t_GPIO_SET_LOW = 41,
    responseEnum_t_GPIO_SET_FAIL = 42,
    responseEnum_t_GPIO_READ_FAIL = 43,
    responseEnum_t_ADC_READ_FAIL = 50,
    responseEnum_t_PWM_SET_OK = 60,
    responseEnum_t_PWM_SET_FAIL = 61,
    responseEnum_t_INVALID_PERIPHERAL = 100
} responseEnum_t;
#define _responseEnum_t_MIN responseEnum_t_INVALID_MESSAGE
#define _responseEnum_t_MAX responseEnum_t_INVALID_PERIPHERAL
#define _responseEnum_t_ARRAYSIZE ((responseEnum_t)(responseEnum_t_INVALID_PERIPHERAL+1))
...
#define i2cMessage_init_default                  {_i2cBus_MIN, 0, 0, _i2cDirection_MIN, _i2cSpeedMode_MIN, 0, false, _i2cFastModeDutyCycle_MIN, 0, 0, 0}
#define spiMessage_init_default                  {_spiBus_MIN, _spiOperatingMode_MIN, 0, 0, 0, 0, 0, _spiHardwareNSS_MIN, _spiFrameFormat_MIN, _spiDataSize_MIN, false, _spiFirstBit_MIN, false, _clockMode_MIN}
...
#define Command_init_default                     {_CommandTypeEnum_MIN, false, i2cMessage_init_default, false, spiMessage_init_default, false, usartMessage_init_default, false, digitalGPIO_init_default, false, analogIN_init_default, false, analogOUT_init_default, false, responseMessage_init_default}
#define i2cMessage_init_zero                     {_i2cBus_MIN, 0, 0, _i2cDirection_MIN, _i2cSpeedMode_MIN, 0, false, _i2cFastModeDutyCycle_MIN, 0, 0, 0}
#define spiMessage_init_zero                     {_spiBus_MIN, _spiOperatingMode_MIN, 0, 0, 0, 0, 0, _spiHardwareNSS_MIN, _spiFrameFormat_MIN, _spiDataSize_MIN, false, _spiFirstBit_MIN, false, _clockMode_MIN}
...
#define Command_init_zero                        {_CommandTypeEnum_MIN, false, i2cMessage_init_zero, false, spiMessage_init_zero, false, usartMessage_init_zero, false, digitalGPIO_init_zero, false, analogIN_init_zero, false, analogOUT_init_zero, false, responseMessage_init_zero}
...
#define i2cMessage_registerSize_tag              10
#define responseMessage_responseRead_tag         1
#define responseMessage_responseEnum_tag         2
#define spiMessage_bus_tag                       1
#define spiMessage_operatingMode_tag             2
#define spiMessage_command_tag                   3
#define spiMessage_dummyClocks_tag               4
#define spiMessage_writeValue_tag                5
#define spiMessage_writeSize_tag                 6
#define spiMessage_slaveResponse_tag             7
#define spiMessage_hardwareNSS_tag               8
#define spiMessage_frameFormat_tag               9
#define spiMessage_dataSize_tag                  10
#define spiMessage_firstBit_tag                  11
#define spiMessage_clockMode_tag                 12
...
extern const pb_field_t i2cMessage_fields[11];
extern const pb_field_t spiMessage_fields[13];
