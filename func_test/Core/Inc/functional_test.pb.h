...
typedef enum _responseEnum_t {
    ...
    responseEnum_t_USART_RX_FAIL = 7,
    responseEnum_t_USART_TX_RX_FAIL = 8,
    responseEnum_t_GPIO_SET_HIGH = 9,
    responseEnum_t_GPIO_SET_LOW = 10,
    responseEnum_t_GPIO_WRITE_FAIL = 11,
    responseEnum_t_PWM_SET = 12,
    responseEnum_t_PWM_RESET = 13,
    responseEnum_t_PWM_SET_FAIL = 14
} responseEnum_t;
