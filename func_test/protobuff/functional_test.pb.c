...
const pb_field_t spiMessage_fields[10] = {
    ...
    PB_FIELD(  5, UENUM   , REQUIRED, STATIC  , OTHER, spiMessage, operatingMode, dummyclocks, 0),
    PB_FIELD(  6, UENUM   , REQUIRED, STATIC  , OTHER, spiMessage, hardwareNSS, operatingMode, 0),
    PB_FIELD(  7, UENUM   , REQUIRED, STATIC  , OTHER, spiMessage, frameFormat, hardwareNSS, 0),
    PB_FIELD(  8, UENUM   , REQUIRED, STATIC  , OTHER, spiMessage, dataSize, frameFormat, 0),
    PB_FIELD(  9, UENUM   , OPTIONAL, STATIC  , OTHER, spiMessage, firstBit, dataSize, 0),
    PB_LAST_FIELD
};
