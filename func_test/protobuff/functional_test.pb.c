...
const pb_field_t spiMessage_fields[11] = {
    ...
    PB_FIELD( 10, UENUM   , OPTIONAL, STATIC  , OTHER, spiMessage, firstBit, dataSize, 0),
    PB_LAST_FIELD
};
...
const pb_field_t usartMessage_fields[12] = {
    ...
    PB_FIELD(  8, UENUM   , OPTIONAL, STATIC  , OTHER, usartMessage, clockPolarity, direction, 0),
    PB_FIELD(  9, UENUM   , OPTIONAL, STATIC  , OTHER, usartMessage, clockPhase, clockPolarity, 0),
    PB_FIELD( 10, UENUM   , OPTIONAL, STATIC  , OTHER, usartMessage, clockLastBit, clockPhase, 0),
    PB_FIELD( 11, UENUM   , OPTIONAL, STATIC  , OTHER, usartMessage, hwFlowControl, clockLastBit, 0),
    PB_LAST_FIELD
};
