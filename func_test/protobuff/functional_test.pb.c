...
const pb_field_t spiTest_fields[4] = {
    PB_FIELD(  1, UENUM   , REQUIRED, STATIC  , FIRST, spiTest, bus, bus, 0),
    PB_FIELD(  2, UENUM   , REQUIRED, STATIC  , OTHER, spiTest, mode, bus, 0),
    PB_FIELD(  3, UINT32  , REQUIRED, STATIC  , OTHER, spiTest, command, mode, 0),
    PB_LAST_FIELD
};
...
const pb_field_t Command_fields[8] = {
    ...
    PB_FIELD(  3, MESSAGE , OPTIONAL, STATIC  , OTHER, Command, spiTestType, i2c, &spiTest_fields),
 ...
 * field descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(Command, i2c) < 65536 && pb_membersize(Command, spiTestType) < 65536 && pb_membersize(Command, gpioTestType) < 65536 && pb_membersize(Command, timerTestType) < 65536 && pb_membersize(Command, pwmTestType) < 65536 && pb_membersize(Command, ledTesType) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_i2cMessage_spiTest_gpioTest_timerTest_pwmTest_ledTest_Command)
#endif
 ...
 * 8 bit descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(Command, i2c) < 256 && pb_membersize(Command, spiTestType) < 256 && pb_membersize(Command, gpioTestType) < 256 && pb_membersize(Command, timerTestType) < 256 && pb_membersize(Command, pwmTestType) < 256 && pb_membersize(Command, ledTesType) < 256), YOU_MUST_DEFINE_PB_FIELD_16BIT_FOR_MESSAGES_i2cMessage_spiTest_gpioTest_timerTest_pwmTest_ledTest_Command)
#endif
